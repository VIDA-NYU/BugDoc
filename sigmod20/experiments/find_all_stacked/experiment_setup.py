...
import run_trees, run_qm, run_data_xray, \
    run_smac, run_explanation_tables,run_shortcut, run_stacked_shortcut, read_results


def prepare(num_params, num_values):
    data_folder = os.getcwd() + '/find_all_stacked/data'
    data_folder_smac = os.getcwd() + '/find_all_stacked/data_smac'
...
def run():
    experiements_path = os.getcwd() + '/find_all_stacked/data'
    ...
    experiements_path = os.getcwd() + '/find_all_stacked/data_smac'
