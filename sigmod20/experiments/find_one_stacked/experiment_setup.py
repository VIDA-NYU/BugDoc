...
def prepare(num_params, num_values):
    data_folder = os.getcwd() + '/find_one_stacked/data'
    data_folder_smac = os.getcwd() + '/find_one_stacked/data_smac'
...
def run():
    ...
    prev = 0
    experiements_path = os.getcwd() + '/find_one_stacked/data'
    ...
    experiements_path = os.getcwd() + '/find_one_stacked/data_smac'
