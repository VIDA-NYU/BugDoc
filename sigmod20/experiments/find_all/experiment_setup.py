...
import run_trees, run_qm, run_data_xray, read_results,run_shortcut, run_stacked_shortcut, \
    run_explanation_tables, run_smac, read_answer_sizes
...
def prepare(num_params, num_values):
    ...
    data_folder_smac = os.getcwd() + '/find_all/data_smac'
...
def run():
    ...
    experiements_path = os.getcwd() + '/find_all/data'
    ...
    experiements_path = os.getcwd() + '/find_all/data_smac'
...
def read_answers():
    ...
    algos = ['shortcut', 'stacked', 'bugdoc', 'dataxray', 'explanation']
    experiements_path = os.getcwd() + '/find_all/data'
    read_answer_sizes.execute(experiements_path, algos, iterations)
