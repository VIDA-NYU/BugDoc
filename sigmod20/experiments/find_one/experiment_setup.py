...
import run_trees, run_qm, run_data_xray, run_explanation_tables, \
    run_smac, run_shortcut, run_stacked_shortcut, read_results


def prepare(num_params, num_values):
    data_folder = os.getcwd() + '/find_one/data'
    data_folder_smac = os.getcwd() + '/find_one/data_smac'
...
def run():
    ...
    experiements_path = os.getcwd() + '/find_one/data'
    run_trees.execute(experiements_path, max_iter=max_iter, mode='first')
    ...
    experiements_path = os.getcwd() + '/find_one/data_smac'
    ...
    run_stacked_shortcut.execute(experiements_path, max_iter=max_iter)
