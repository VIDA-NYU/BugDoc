...
def prepare(num_params, num_values):
    data_folder = os.getcwd() + '/selective_evaluation_ineq_conj/data_trees'
    data_folder_selective = os.getcwd() + '/selective_evaluation_ineq_conj/data_selective'
...
def run():
    ...
    experiements_path = os.getcwd() + '/selective_evaluation_ineq_conj/data_trees'
    run_trees.execute(experiements_path, max_iter=max_iter)
    run_qm.execute(experiements_path, max_iter=max_iter)

    experiements_path = os.getcwd() + '/selective_evaluation_ineq_conj/data_selective'
